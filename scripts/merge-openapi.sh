...
if HAS_YAML:
    ...
    # Write a generated-file notice at the top, then dump the merged YAML.
    # This makes it clear the file is generated and should not be edited by hand.
    with open(output_file, "w") as fh:
        fh.write("# This file is generated by scripts/merge-openapi.sh - DO NOT EDIT\n")
...
# ---------------------------------------------------------------------------
    ...
    out_lines = []
    # Add generated-file notice as the very first line
    out_lines.append("# This file is generated by scripts/merge-openapi.sh - DO NOT EDIT\n")
...
# This file is generated by scripts/merge-openapi.sh - DO NOT EDIT
openapi: 3.0.3
info:
  title: Orbit Core API
  description: A comprehensive personal productivity API with calendar, tasks, location tracking, and integration capabilities
